        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="configuration in spuSaleAttrList" :key="configuration.id">
                <dt class="title">{{ configuration.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValue.isChecked == 1 }"
                  v-for="spuSaleAttrValue in configuration.spuSaleAttrValueList"
                  :key="spuSaleAttrValue.id"
                  @click="checkConfig(spuSaleAttrValue, configuration.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model.number="goodsNum" @blur="changeGoodsNum" />
...
export default {
  ...
  methods: {
    checkConfig(spuSaleAttrValue, arr) {
      arr.forEach(item => {
        item.isChecked = 0
      })
