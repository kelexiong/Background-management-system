<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="(item, index) in detailArrayList" :key="index">
          <li>
            <img :src="item.imgUrl" />
          </li>
          <li>
    ...
    <div class="trade">
      <div class="price">
        应付金额:　<span>¥{{ sumpirce }}.00</span>
      </div>
      <div class="receiveInfo">
        寄送至:
        <span>{{ recipientsData.fullAddress }}</span>
        收货人：<span>{{ recipientsData.consignee }}</span>
        <span>{{ recipientsData.phoneNum }}</span>
      </div>
    </div>
